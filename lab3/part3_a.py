...
WIKI_INDEX_NAME = os.path.join(os.path.dirname(__file__), "bm25_wiki_index") # Assumed path from your indexer script
...
# Prompt Constants
RAG_SYS_PROMPT = "You are a helpful assistant whose job it is to answer general knowledge questions. Please answer concisely. Below is the retrieved context before the user's query to help you answer the question."
...
def make_formatted_prompt(current_user_prompt: str, context: str, system_prompt: str) -> str:
    ...
    The context is placed *before* the user's question. (This is Prompt Format 1 for part 3b)
    """
    base = "<|begin_of_text|>"
    segments = []
