...
WIKI_INDEX_PATH = os.path.join(os.path.dirname(__file__), "bm25_wiki_index") # Assumed path from your indexer script
...
if __name__ == "__main__":
    ...
    try:
        ...
        re_ranker = CrossEncoder('cross-encoder/ms-marco-L6-v2', token=HF_TOKEN)
    except Exception as e:
